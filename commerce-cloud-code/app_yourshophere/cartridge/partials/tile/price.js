function getListPrices(httpParams) {
    ...
    let listPriceMin;
    let listPriceMax;
    return productCache.get(`price_${httpParams.get('pid')}_${request.locale}`, () => {
        try {
...
exports.createModel = (hit, tileSearch, httpParams) => {
    ...
    const salePriceMax = tileSearch.maxPrice;
    const salePriceMin = tileSearch.minPrice;
    const salePrice = salePriceMin;
    const rangeSalePrice = salePriceMin !== salePriceMax;
